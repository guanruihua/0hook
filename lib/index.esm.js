...
function useStorage(key, initialValue, options = {}) {
    ...
    const [value, _setValue] = React.useState(getDefaultValue() || '');
...
export { useBoolean, useCount, useDebounceEffect, useEventController, useEventListener, useInterval, useLocalStorage, useMap, useObject, useSessionStorage, useSetState, useSetTimeout, useStorage, useUpdate };
